...
<div class="container">    
        ...
        <div class="card-deck">
          ...
          <div class="col-lg-3 col-md-4 col-md-4 mb-3">
            <div class="card text-center borda-card border-dark">
              ...
              <div class="btn-card">                
                <a href="<?php echo $url_atual?>/resgate"><button type="button" class="btn card__btn">Saiba mais</button></a>
              </div>              
            </div>
          </div>         
          ...
          <div class="col-lg-3 col-md-4 mb-3">
            <div class="card text-center borda-card border-dark">
              ...
              <div class="btn-card">
                <a href="<?php echo $url_atual?>/adocao"><button type="button" class="btn card__btn">Saiba mais</button></a>            
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 mb-3">
            <div class="card text-center borda-card border-dark">
              ...
              <div class="btn-card">
                <a href="<?php echo $url_atual?>/castracao"><button type="button" class="btn card__btn">Saiba mais</button></a>
              </div>
            </div>
          </div>

          <div class="col-lg-3 col-md-4 mb-3 borda-card">
            <div class="card text-center borda-card border-dark">
              ...
              <div class="btn-card">
                  <a href="<?php echo $url_atual?>/queroajudar"><button type="button" class="btn card__btn">Saiba mais</button></a>            
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 mb-3">
            <div class="card text-center borda-card border-dark">
              ...
              <div class="btn-card">
                  <a href="<?php echo $url_atual?>/lartemporario"><button type="button" class="btn card__btn">Saiba mais</button></a>            
              </div>
            </div>
          </div>
